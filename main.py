...
cor2 = "#f2faf2" #branco
cor3 = "#2b2c36" #azul
cor4 = "#21422a" #verde escuro
cor5 = "#c1ebb0" #verde claro
...
b_2.place(x=118, y=0)
b_3 = Button(frame_corpo, command = lambda: entrar_valores('/'), text="/", width=5, height=2, bg=cor4, font=('Ivy 13 bold'),
             relief= RAISED, overrelief=RIDGE, fg=cor2)
b_3.place(x=177, y=0)
...
b_7 = Button(frame_corpo, command = lambda: entrar_valores('*'),text="*", width=5, height=2, bg=cor4, font=('Ivy 13 bold'),relief= RAISED,
             overrelief=RIDGE, fg=cor2)
...
b_11= Button(frame_corpo, command = lambda: entrar_valores('-'), text="-", width=5, height=2, bg=cor4, font=('Ivy 13 bold'),relief= RAISED, 
             overrelief=RIDGE, fg=cor2)
...
b_15= Button(frame_corpo, command = lambda: entrar_valores('+'), text="+", width=5, height=2, bg=cor4, font=('Ivy 13 bold'),relief= RAISED,
             overrelief=RIDGE, fg=cor2)
...
b_18 = Button(frame_corpo, command = calcular , text="=", width=5, height=2, bg=cor4, font=('Ivy 13 bold'),relief= RAISED, overrelief=RIDGE, fg=cor2)
